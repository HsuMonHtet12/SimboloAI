...
json_file = open('C:/Users/STH/Desktop/Emotions/emotion_model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
emotion_model = model_from_json(loaded_model_json)

# load weights into new model
emotion_model.load_weights("C:/Users/STH/Desktop/Emotions/emotion_model.h5")
st.header(":blue[Emotions Detection System]")

option = st.selectbox(
    'Two Options for your test',
